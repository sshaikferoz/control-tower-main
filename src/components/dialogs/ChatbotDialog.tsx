...
const ChatbotDialog: React.FC<ChatbotDialogProps> = ({ isOpen, onClose }) => {
    ...
    const iframeSrc = useMemo(() => {
        // Match other areas that use BSP-hosted *.html pages in production.
        if (process.env.NODE_ENV === 'development') return '/chatbot.html';
        const bsp = process.env.NEXT_PUBLIC_BSP_NAME;
        return bsp ? `${bsp}/chatbot.html` : '/chatbot.html';
    }, []);
