...
import ColorPaletteConfigUI from '../ColorPaletteConfigUI';
...
export const ConfigurationDialog: React.FC<ConfigurationDialogProps> = ({
    ...
    const tabs = [
        ...
        { label: 'Color Palettes', icon: 'pi pi-palette', id: 'colorPalettes' },
    ];
                                ...
                                <>
                                    ...
                                    <div>
                                        ...
                                        <div className="relative h-20 w-full rounded border border-[#3a5a8b] bg-[#2a4a7b]">
                                            <div
                                                className={`absolute flex h-10 w-10 items-center justify-center rounded-full shadow-lg ${formData.chatbot.position.includes('right') ? 'right-3' : 'left-3'
