...
const defaultConfig: GaugeWidgetConfig = {
    minValue: 0,
    maxValue: 100,
    colorRanges: [
...
export const GaugeConfigPanel: React.FC<GaugeConfigPanelProps> = ({
    ...
    const handleChange = (key: keyof GaugeWidgetConfig, newValue: any) => {
        onChange({
            ...config,
            [key]: newValue,
        });
        ...
        <div className="text-white">
            ...
            <div className="mb-4">
                ...
                <Typography variant="caption" className="mb-4 text-white/70 text-xs block">
                    Configure color ranges for the gauge scale. Each range will be displayed with its assigned color.
                </Typography>
                                ...
                                <div className="flex gap-2 mb-2">
                                    <div className="flex-1">
                                        ...
                                        <TextField
                                            ...
                                            fullWidth
                                            value={range.min}
                                            onChange={(e) => handleColorRangeChange(index, 'min', parseFloat(e.target.value) || 0)}
                                            inputProps={{
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <TextField
                                            ...
                                            fullWidth
                                            value={range.max}
                                            onChange={(e) => handleColorRangeChange(index, 'max', parseFloat(e.target.value) || 0)}
                                            inputProps={{
                                                style: { color: 'white', fontSize: '0.75rem', padding: '6px 8px' },
                                            }}
                                            sx={{
            ...
            <div className="mb-4">
                ...
                <Typography variant="caption" className="mb-4 text-white/70 text-xs block">
                    Select which field to use for the gauge value. The gauge displays a single value from the query result.
                </Typography>
