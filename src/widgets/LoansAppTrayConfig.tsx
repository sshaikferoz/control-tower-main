...
const LoansAppTrayConfig: React.FC<LoansAppTrayConfigProps> = ({
    ...
    // Get current title from widgetConfigurations
    const currentTitle = widgetConfigurations[selectedWidget]?.title || '';
                                            ...
                                            >
                                                {fieldMappings[selectedWidget]?.menuItemConfigs?.[item.id]?.queryConfig
                                                    ...
                                                    fieldMappings[selectedWidget]?.menuItemConfigs?.[item.id]?.queryConfig
                                                        ...
                                                        fieldMappings[selectedWidget]?.menuItemConfigs?.[item.id]?.queryConfig
                                                            ?.manualValue !== null
                                                        ? String(fieldMappings[selectedWidget]?.menuItemConfigs?.[item.id]?.queryConfig?.manualValue)
                                                        : 'No value set'
                                                ) : (
                                                    (() => {
                                                        const mappedConfig = fieldMappings[selectedWidget]?.menuItemConfigs?.[item.id]?.queryConfig?.mappedConfig;
                                                        if (mappedConfig?.chaField && mappedConfig?.chaValue && mappedConfig?.kfField) {
                                                        ...
                                                        return 'Configure mapping to see preview';
                                                    })()
                                                )}
                                            </Typography>
                                        </Box>
