...
const MultiMetrics = lazy(() => import('@/features/widgets/components/MultiMetrics'));
const PieMetric = lazy(() => import('@/features/widgets/components/PieMetric'));
const SimpleMetric = lazy(() => import('@/features/widgets/components/SimpleMetric'));
const SimpleMetricDate = lazy(() => import('@/features/widgets/components/SimpleMetricDate'));
const SingleLineChart = lazy(() => import('@/features/widgets/components/SingleLineChart'));
const TableMetric = lazy(() => import('@/features/widgets/components/TableMetric'));
const BarMetric = lazy(() => import('@/features/widgets/components/BarMetric'));
const StackedBarChart = lazy(() => import('@/features/widgets/components/StackedBarChart'));
const OrdersLineChart = lazy(() => import('@/features/widgets/components/OrdersLineChart'));
const DualLineChart = lazy(() => import('@/features/widgets/components/DualLineChart'));
const PieChartWithTotal = lazy(() => import('@/features/widgets/components/PieChartWithTotal'));
const QuadrantMetrics = lazy(() => import('@/features/widgets/components/QuadrantMetrics'));
const LoansAppTray = lazy(() => import('@/features/widgets/components/LoansAppTray'));
const NewsFeed = lazy(() => import('@/features/widgets/components/NewsFeed'));
const Announcement = lazy(() => import('@/features/widgets/components/Announcement1'));
const pieChart = lazy(() => import('@/features/widgets/components/PieChart'));
const ColumnChart = lazy(() => import('@/features/widgets/components/ColumnChart'));
const PredictionChart = lazy(() => import('@/features/widgets/components/Prediction'));
const RadarChartComponent = lazy(() => import('@/features/widgets/components/RadarChart'));
const MultiChart = lazy(() => import('@/features/widgets/components/MultiChart'));

// Component mappings with lazy loading
export const widgetMapping: Record<string, ComponentType<any>> = {
